...
kal_bool OV5648MIPIDuringTestPattern_sunwin = KAL_FALSE;
#define OV5648MIPI_TEST_PATTERN_CHECKSUM (0xc24ec08d)

extern int iReadRegI2C(u8 *a_pSendData , u16 a_sizeSendData, u8 * a_pRecvData, u16 a_sizeRecvData, u16 i2cId);
extern int iWriteRegI2C(u8 *a_pSendData , u16 a_sizeSendData, u16 i2cId);
void OV5648MIPISetMaxFrameRate_sunwin(UINT16 u2FrameRate);
...
static void OV5648MIPI_Write_Shutter(kal_uint16 iShutter)
{
    ...
    if(OV5648MIPIAutoFlickerMode){
        if(OV5648MIPI_sensor.video_mode == KAL_FALSE){
            if(mCurrentScenarioId == MSDK_SCENARIO_ID_CAMERA_ZSD)
            {
                ...
                OV5648MIPISetMaxFrameRate_sunwin(148);
            }
            else
            {
                //Change frame 29.5fps ~ 29.8fps to do auto flick
                OV5648MIPISetMaxFrameRate_sunwin(296);
            }
        }
    }
	...
	OV5648MIPI_write_cmos_sensor_sunwin(0x350c, (extra_line >> 8) & 0xFF);	
	OV5648MIPI_write_cmos_sensor_sunwin(0x350d, (extra_line) & 0xFF); 
    ...
    // Extend frame length
    OV5648MIPI_write_cmos_sensor_sunwin(0x380f, frame_length & 0xFF);
    OV5648MIPI_write_cmos_sensor_sunwin(0x380e, frame_length >> 8);
    
#endif

    // Update Shutter
    OV5648MIPI_write_cmos_sensor_sunwin(0x3502, (iShutter << 4) & 0xFF);
    OV5648MIPI_write_cmos_sensor_sunwin(0x3501, (iShutter >> 4) & 0xFF);     
    OV5648MIPI_write_cmos_sensor_sunwin(0x3500, (iShutter >> 12) & 0x0F);
}   /*  OV5648MIPI_Write_Shutter  */

static void OV5648MIPI_Set_Dummy_sunwin(const kal_uint16 iDummyPixels, const kal_uint16 iDummyLines)
{
    ...
    OV5648MIPI_write_cmos_sensor_sunwin(0x380c, line_length >> 8);
    OV5648MIPI_write_cmos_sensor_sunwin(0x380d, line_length & 0xFF);
    OV5648MIPI_write_cmos_sensor_sunwin(0x380e, frame_length >> 8);
    OV5648MIPI_write_cmos_sensor_sunwin(0x380f, frame_length & 0xFF);
...
void OV5648MIPISetMaxFrameRate_sunwin(UINT16 u2FrameRate)
{
    ...
    OV5648MIPI_Set_Dummy_sunwin(OV5648MIPI_sensor.dummy_pixel, dummy_line); /* modify dummy_pixel must gen AE table again */
}   /*  OV5648MIPISetMaxFrameRate_sunwin  */
...
*
*************************************************************************/
void set_OV5648MIPI_shutter_sunwin(kal_uint16 iShutter)
{
    unsigned long flags;
...
static kal_uint16 OV5648MIPI_Reg2Gain(const kal_uint8 iReg)
{
 ...
 kal_uint8 OV5648MIPI_Gain2Reg_sunwin(const kal_uint16 iGain)
{
...
*
*************************************************************************/
kal_uint16 OV5648MIPI_SetGain_sunwin(kal_uint16 iGain)
{
    kal_uint8 iRegGain;
    ...
    if(iGain >= BASEGAIN && iGain <= 32 * BASEGAIN){
        ...
        iRegGain = OV5648MIPI_Gain2Reg_sunwin(iGain);
        ...
        OV5648MIPI_write_cmos_sensor_sunwin(0x350b, iRegGain);
    } else {
...
void OV5648MIPI_Set_Mirror_Flip_sunwin(kal_uint8 image_mirror)
{
...
*
*************************************************************************/
void OV5648MIPI_night_mode_sunwin(kal_bool enable)
{
/*No Need to implement this function*/ 
}   /*  OV5648MIPI_night_mode_sunwin  */


/* write camera_para to sensor register */
static void OV5648MIPI_camera_para_to_sensor_sunwin(void)
{
    kal_uint32 i;

    SENSORDB("OV5648MIPI_camera_para_to_sensor_sunwin\n");

    for (i = 0; 0xFFFFFFFF != OV5648MIPI_sensor.eng.reg[i].Addr; i++)
    {
        OV5648MIPI_write_cmos_sensor_sunwin(OV5648MIPI_sensor.eng.reg[i].Addr, OV5648MIPI_sensor.eng.reg[i].Para);
    }
    for (i = OV5648MIPI_FACTORY_START_ADDR; 0xFFFFFFFF != OV5648MIPI_sensor.eng.reg[i].Addr; i++)
    {
        OV5648MIPI_write_cmos_sensor_sunwin(OV5648MIPI_sensor.eng.reg[i].Addr, OV5648MIPI_sensor.eng.reg[i].Para);
    }
    OV5648MIPI_SetGain_sunwin(OV5648MIPI_sensor.gain); /* update gain */
}

/* update camera_para from sensor register */
static void OV5648MIPI_sensor_to_camera_para_sunwin(void)
{
    kal_uint32 i,temp_data;

    SENSORDB("OV5648MIPI_sensor_to_camera_para_sunwin\n");

    for (i = 0; 0xFFFFFFFF != OV5648MIPI_sensor.eng.reg[i].Addr; i++)
    {
        temp_data =OV5648MIPI_read_cmos_sensor_sunwin(OV5648MIPI_sensor.eng.reg[i].Addr);
...
/* ------------------------ Engineer mode ------------------------ */
inline static void OV5648MIPI_get_sensor_group_count_sunwin(kal_int32 *sensor_count_ptr)
{

    SENSORDB("OV5648MIPI_get_sensor_group_count_sunwin\n");

    *sensor_count_ptr = OV5648MIPI_GROUP_TOTAL_NUMS;
}

inline static void OV5648MIPI_get_sensor_group_info_sunwin(MSDK_SENSOR_GROUP_INFO_STRUCT *para)
{

    SENSORDB("OV5648MIPI_get_sensor_group_info_sunwin\n");
...
inline static void OV5648MIPI_get_sensor_item_info_sunwin(MSDK_SENSOR_ITEM_INFO_STRUCT *para)
{
    ...
    SENSORDB("OV5648MIPI_get_sensor_item_info_sunwin");
...
inline static kal_bool OV5648MIPI_set_sensor_item_info_sunwin(MSDK_SENSOR_ITEM_INFO_STRUCT *para)
{
    kal_uint16 temp_para;

    SENSORDB("OV5648MIPI_set_sensor_item_info_sunwin\n");
    ...
    case OV5648MIPI_REGISTER_EDITOR:
        ...
        case 1:
            ...
            OV5648MIPI_write_cmos_sensor_sunwin(fac_sensor_reg, para->ItemValue);
            break;
        default:
            ASSERT(0);
        }
...
static void OV5648MIPI_Sensor_Init_sunwin(void)
{
#ifdef OV5648MIPI_DRIVER_TRACE
   SENSORDB("Enter!");
#endif
    ...
    */
    ...
    OV5648MIPI_write_cmos_sensor_sunwin(0x3013, 0x08);
    ...
    OV5648MIPI_write_cmos_sensor_sunwin(0x3601, 0x33); // analog control
    OV5648MIPI_write_cmos_sensor_sunwin(0x3602, 0x00); // analog control
    OV5648MIPI_write_cmos_sensor_sunwin(0x3611, 0x0e); // analog control
    OV5648MIPI_write_cmos_sensor_sunwin(0x3612, 0x2b); // analog control
    OV5648MIPI_write_cmos_sensor_sunwin(0x3614, 0x50); // analog control
    OV5648MIPI_write_cmos_sensor_sunwin(0x3620, 0x33); // analog control
    OV5648MIPI_write_cmos_sensor_sunwin(0x3622, 0x00); // analog control
    OV5648MIPI_write_cmos_sensor_sunwin(0x3630, 0xad); // analog control
    OV5648MIPI_write_cmos_sensor_sunwin(0x3631, 0x00); // analog control
    OV5648MIPI_write_cmos_sensor_sunwin(0x3632, 0x94); // analog control
    OV5648MIPI_write_cmos_sensor_sunwin(0x3633, 0x17); // analog control
    OV5648MIPI_write_cmos_sensor_sunwin(0x3634, 0x14); // analog control

    // fix EV3 issue
    OV5648MIPI_write_cmos_sensor_sunwin(0x3704, 0xc0); // analog control
    
    OV5648MIPI_write_cmos_sensor_sunwin(0x3705, 0x2a); // analog control
    OV5648MIPI_write_cmos_sensor_sunwin(0x3708, 0x66); // analog control
    OV5648MIPI_write_cmos_sensor_sunwin(0x3709, 0x52); // analog control
    OV5648MIPI_write_cmos_sensor_sunwin(0x370b, 0x23); // analog control
    OV5648MIPI_write_cmos_sensor_sunwin(0x370c, 0xc3); // analog control
    OV5648MIPI_write_cmos_sensor_sunwin(0x370d, 0x00); // analog control
    OV5648MIPI_write_cmos_sensor_sunwin(0x370e, 0x00); // analog control
    OV5648MIPI_write_cmos_sensor_sunwin(0x371c, 0x07); // analog control
    OV5648MIPI_write_cmos_sensor_sunwin(0x3739, 0xd2); // analog control
    ...
    OV5648MIPI_Set_Mirror_Flip_sunwin(IMAGE_HV_MIRROR);
    ...
    OV5648MIPI_write_cmos_sensor_sunwin(0x4800, 0x14); // MIPI line sync enable
...
static void OV5648MIPI_Preview_Setting_sunwin(void)
{
    ...
    //OV5648MIPI_write_cmos_sensor_sunwin(0x380e, 0x03); // vts = 992
    //OV5648MIPI_write_cmos_sensor_sunwin(0x380f, 0xE0); // vts
    OV5648MIPI_write_cmos_sensor_sunwin(0x380c, ((OV5648MIPI_PV_PERIOD_PIXEL_NUMS >> 8) & 0xFF)); // hts = 2816
    OV5648MIPI_write_cmos_sensor_sunwin(0x380d, (OV5648MIPI_PV_PERIOD_PIXEL_NUMS & 0xFF));        // hts
    OV5648MIPI_write_cmos_sensor_sunwin(0x380e, ((OV5648MIPI_PV_PERIOD_LINE_NUMS >> 8) & 0xFF));  // vts = 992
    OV5648MIPI_write_cmos_sensor_sunwin(0x380f, (OV5648MIPI_PV_PERIOD_LINE_NUMS & 0xFF));         // vts
...
static void OV5648MIPI_Capture_Setting_sunwin(void)
{
#ifdef OV5648MIPI_DRIVER_TRACE
    SENSORDB("Enter!");
#endif
    ...
    OV5648MIPI_write_cmos_sensor_sunwin(0x380c, ((OV5648MIPI_FULL_PERIOD_PIXEL_NUMS >> 8) & 0xFF)); // hts = 2816
    OV5648MIPI_write_cmos_sensor_sunwin(0x380d, (OV5648MIPI_FULL_PERIOD_PIXEL_NUMS & 0xFF));        // hts
    OV5648MIPI_write_cmos_sensor_sunwin(0x380e, ((OV5648MIPI_FULL_PERIOD_LINE_NUMS >> 8) & 0xFF));  // vts = 1984
    OV5648MIPI_write_cmos_sensor_sunwin(0x380f, (OV5648MIPI_FULL_PERIOD_LINE_NUMS & 0xFF));         // vts
...
*
*************************************************************************/
UINT32 OV5648MIPIOpen_sunwin(void)
{
    ...
    otp_update_wb_sunwin(0x187, 0x152);//hufan add for sanyingxing

    spin_lock(&ov5648mipi_drv_lock);
    OV5648MIPIDuringTestPattern_sunwin = KAL_FALSE;    
...
*
*************************************************************************/
UINT32 OV5648GetSensorID_sunwin(UINT32 *sensorID) 
{
    // check if sensor ID correct
    unsigned int data[4];
    int volt = 0;
	
    *sensorID=((OV5648MIPI_read_cmos_sensor_sunwin(0x300A) << 8) | OV5648MIPI_read_cmos_sensor_sunwin(0x300B));   

    SENSORDB("Sensor ID: 0x%x ", *sensorID);

#if 0
    IMM_GetOneChannelValue(1, data, &volt);
    SENSORDB("OV5648GetSensorID_sunwin     volt = %d " ,volt );
	
    if (OV5648MIPI_SENSOR_ID == *sensorID  && volt <= 500)
    {
        SENSORDB(" this is sunwin ov5648 camera module.");
    }
    else
    {
        *sensorID=0xFFFFFFFF;
...
//BEGIN <> <20130828> <check the truly MID> panzaoyan
    ...
    if( 0==check_sunwin_MID(0) ) //it is not sunwin module
    	{	

		SENSORDB("check_sunwinMIDFailed\n");
 ...
 //END <> <20130828> <check the truly MID>> panzaoyan
    ...
    *sensorID = OV5648MIPI_SENSOR_ID_SUNWIN;
    SENSORDB(" this is darling ov5648 TDK camera module.");	
...
*
*************************************************************************/
UINT32 OV5648MIPIClose_sunwin(void)
{
    /*No Need to implement this function*/ 
...
*
*************************************************************************/
UINT32 OV5648MIPIPreview_sunwin(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
...
UINT32 OV5648MIPIZSDPreview_sunwin(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    SENSORDB("Enter!");
    ...
    return ERROR_NONE;
}   /*  OV5648MIPIZSDPreview_sunwin   */

/*************************************************************************
* FUNCTION
*   OV5648MIPICapture_sunwin
*
* DESCRIPTION
...
*
*************************************************************************/
UINT32 OV5648MIPICapture_sunwin(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
                          MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    SENSORDB("Enter!");
...
UINT32 OV5648MIPIGetResolution_sunwin(MSDK_SENSOR_RESOLUTION_INFO_STRUCT *pSensorResolution)
{
#ifdef OV5648MIPI_DRIVER_TRACE
    SENSORDB("Enter");
#endif
...
UINT32 OV5648MIPIGetInfo_sunwin(MSDK_SCENARIO_ID_ENUM ScenarioId,
...
UINT32 OV5648MIPIControl_sunwin(MSDK_SCENARIO_ID_ENUM ScenarioId, MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *pImageWindow,
                      MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    SENSORDB("ScenarioId = %d", ScenarioId);
    ...
    switch (ScenarioId)
    {
        ...
        case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
            OV5648MIPIPreview_sunwin(pImageWindow, pSensorConfigData);
            break;
        case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
            OV5648MIPICapture_sunwin(pImageWindow, pSensorConfigData);
            break;
        case MSDK_SCENARIO_ID_CAMERA_ZSD:
            OV5648MIPIZSDPreview_sunwin(pImageWindow, pSensorConfigData);
            break;      
        default:
...
UINT32 OV5648MIPISetVideoMode_sunwin(UINT16 u2FrameRate)
{
    SENSORDB("u2FrameRate = %d ", u2FrameRate);
    ...
    OV5648MIPISetMaxFrameRate_sunwin(u2FrameRate);
    OV5648MIPI_Write_Shutter(OV5648MIPI_sensor.shutter);//From Meimei Video issue

    return ERROR_NONE;
}

UINT32 OV5648MIPISetAutoFlickerMode_sunwin(kal_bool bEnable, UINT16 u2FrameRate)
{
    ...
    if(bEnable){
        ...
        if((OV5648MIPI_sensor.FixedFps == 30)&&(OV5648MIPI_sensor.video_mode==KAL_TRUE))
            OV5648MIPISetMaxFrameRate_sunwin(300);
        else if((OV5648MIPI_sensor.FixedFps == 15)&&(OV5648MIPI_sensor.video_mode==KAL_TRUE))
            OV5648MIPISetMaxFrameRate_sunwin(150);            
    }
...
UINT32 OV5648MIPISetMaxFrameRateByScenario_sunwin(MSDK_SCENARIO_ID_ENUM scenarioId, MUINT32 frameRate) 
{
    kal_uint32 pclk;
	kal_int16 dummyLine;
    ...
    switch (scenarioId) {
		case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
			...
			OV5648MIPI_Set_Dummy_sunwin(0, dummyLine);			
			break;			
		case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
...
UINT32 OV5648MIPIGetDefaultFramerateByScenario_sunwin(MSDK_SCENARIO_ID_ENUM scenarioId, MUINT32 *pframeRate) 
{
...
UINT32 OV5648MIPI_SetTestPatternMode_sunwin(kal_bool bEnable)
{
	...
	{
	    spin_lock(&ov5648mipi_drv_lock);
        OV5648MIPIDuringTestPattern_sunwin = KAL_TRUE;
        spin_unlock(&ov5648mipi_drv_lock);
...
UINT32 OV5648MIPIFeatureControl_sunwin(MSDK_SENSOR_FEATURE_ENUM FeatureId,
                             UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    switch (FeatureId)
    {
        ...
        case SENSOR_FEATURE_SET_ESHUTTER:
            set_OV5648MIPI_shutter_sunwin(*pFeatureData16);
            break;
        case SENSOR_FEATURE_SET_NIGHTMODE:
            OV5648MIPI_night_mode_sunwin((BOOL) *pFeatureData16);
            break;
        case SENSOR_FEATURE_SET_GAIN:       
            OV5648MIPI_SetGain_sunwin((UINT16) *pFeatureData16);
            break;
        ...
        case SENSOR_FEATURE_SET_REGISTER:
            OV5648MIPI_write_cmos_sensor_sunwin(pSensorRegData->RegAddr, pSensorRegData->RegData);
            break;
        case SENSOR_FEATURE_GET_REGISTER:
            pSensorRegData->RegData = OV5648MIPI_read_cmos_sensor_sunwin(pSensorRegData->RegAddr);
            break;
        ...
        case SENSOR_FEATURE_CAMERA_PARA_TO_SENSOR:
             OV5648MIPI_camera_para_to_sensor_sunwin();
            break;
        case SENSOR_FEATURE_SENSOR_TO_CAMERA_PARA:
            OV5648MIPI_sensor_to_camera_para_sunwin();
            break;                          
        case SENSOR_FEATURE_GET_GROUP_COUNT:
            OV5648MIPI_get_sensor_group_count_sunwin((kal_uint32 *)pFeaturePara);
            *pFeatureParaLen = 4;
            break;    
        case SENSOR_FEATURE_GET_GROUP_INFO:
            OV5648MIPI_get_sensor_group_info_sunwin((MSDK_SENSOR_GROUP_INFO_STRUCT *)pFeaturePara);
            *pFeatureParaLen = sizeof(MSDK_SENSOR_GROUP_INFO_STRUCT);
            break;
        case SENSOR_FEATURE_GET_ITEM_INFO:
            OV5648MIPI_get_sensor_item_info_sunwin((MSDK_SENSOR_ITEM_INFO_STRUCT *)pFeaturePara);
            *pFeatureParaLen = sizeof(MSDK_SENSOR_ITEM_INFO_STRUCT);
            break;
        case SENSOR_FEATURE_SET_ITEM_INFO:
            OV5648MIPI_set_sensor_item_info_sunwin((MSDK_SENSOR_ITEM_INFO_STRUCT *)pFeaturePara);
            *pFeatureParaLen = sizeof(MSDK_SENSOR_ITEM_INFO_STRUCT);
            break;
        ...
        case SENSOR_FEATURE_SET_VIDEO_MODE:
            OV5648MIPISetVideoMode_sunwin(*pFeatureData16);
            break; 
        case SENSOR_FEATURE_CHECK_SENSOR_ID:
            OV5648GetSensorID_sunwin(pFeatureReturnPara32); 
            break; 
        case SENSOR_FEATURE_SET_AUTO_FLICKER_MODE:
            OV5648MIPISetAutoFlickerMode_sunwin((BOOL)*pFeatureData16,*(pFeatureData16+1));
            break;
		case SENSOR_FEATURE_SET_MAX_FRAME_RATE_BY_SCENARIO:
			OV5648MIPISetMaxFrameRateByScenario_sunwin((MSDK_SCENARIO_ID_ENUM)*pFeatureData32, *(pFeatureData32+1));
			break;
		case SENSOR_FEATURE_GET_DEFAULT_FRAME_RATE_BY_SCENARIO:
			OV5648MIPIGetDefaultFramerateByScenario_sunwin((MSDK_SCENARIO_ID_ENUM)*pFeatureData32, (MUINT32 *)(*(pFeatureData32+1)));
			break;
        case SENSOR_FEATURE_SET_TEST_PATTERN:
            OV5648MIPI_SetTestPatternMode_sunwin((BOOL)*pFeatureData16);
            break;
...
SENSOR_FUNCTION_STRUCT  SensorFuncOV5648MIPI_sunwin=
{
    OV5648MIPIOpen_sunwin,
    OV5648MIPIGetInfo_sunwin,
    OV5648MIPIGetResolution_sunwin,
