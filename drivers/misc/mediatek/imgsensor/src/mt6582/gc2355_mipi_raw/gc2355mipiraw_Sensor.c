 ...
 *
 * 04 10  2013
 * First release MT6582 GC2355MIPI driver Version 1.0
 *
 *------------------------------------------------------------------------------
 *============================================================================
 ****************************************************************************/
...
#if defined(MT6571)||defined(MT6582)
...
static void GC2355MIPI_Sensor_Init(void)
{
...
#endif
	GC2355MIPI_write_cmos_sensor(0xf8,0x04);//0x06 abby 
	...
	GC2355MIPI_write_cmos_sensor(0x05,0x01);//34c
	GC2355MIPI_write_cmos_sensor(0x06,0x6c);
	...
	GC2355MIPI_write_cmos_sensor(0x2c,0x38);//38 abby
	...
	//////////////////////   crop   /////////////////////
	/////////////////////////////////////////////////////
	GC2355MIPI_write_cmos_sensor(0x92,0x02);//0x03//0x01
	GC2355MIPI_write_cmos_sensor(0x94,0x00);//0x00//0x01
...
#endif		
	if (sensor_id != GC2355_MIPI_SENSOR_ID)
...
#endif		
	if (*sensorID != GC2355_MIPI_SENSOR_ID) {		
		*sensorID = 0xFFFFFFFF;		
		return ERROR_SENSOR_CONNECT_FAIL;
	}
   return ERROR_NONE;
...
UINT32 GC2355SetTestPatternMode(kal_bool bEnable)
{
   // GC2355DB("[GC2355SetTestPatternMode] Test pattern enable:%d\n", bEnable);
    if(bEnable)
    {
        GC2355MIPI_write_cmos_sensor(0x8b,0xb2); //bit[4]: 1 enable test pattern, 0 disable test pattern
    }
	else
	{
	    GC2355MIPI_write_cmos_sensor(0x8b,0xa2);//bit[4]: 1 enable test pattern, 0 disable test pattern
	}
    return ERROR_NONE;
}
							 ...
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	switch (FeatureId)
	{
		...
		case SENSOR_FEATURE_GET_REGISTER_DEFAULT:
			...
			((PNVRAM_SENSOR_DATA_STRUCT)pFeaturePara)->SensorId = GC2355_MIPI_SENSOR_ID;
